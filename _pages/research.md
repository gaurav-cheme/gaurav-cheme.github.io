...
<img src="{{ '/images/Reaction_kinetics.png'}}" style="float: left; max-width: 35%; margin-right: 20px; margin-bottom: 15px; border-radius: 4px; border: none !important; 
            box-shadow: none !important; 
            mix-blend-mode: multiply;" alt="Biochemical Reactions in Condensates">
